[Readiness Fix] <REPO_NAME> Product Analytics Instrumentation

Fix the failing signal: Product Analytics Instrumentation ([0/1])
...
**Signal**: Product Analytics Instrumentation
**Score**: [0/1]
