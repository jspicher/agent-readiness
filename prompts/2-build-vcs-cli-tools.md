[Readiness Fix] <REPO_NAME> VCS CLI Tools

Fix the failing signal: VCS CLI Tools ([0/1])
...
**Signal**: VCS CLI Tools
**Score**: [0/1]
**Description**: Version control CLI tools are installed and authenticated for automated checks
