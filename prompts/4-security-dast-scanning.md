[Readiness Fix] <REPO_NAME> DAST Scanning

Fix the failing signal: DAST Scanning ([0/1])
...
**Signal**: DAST Scanning
**Score**: [0/1]
**Description**: Dynamic Application Security Testing runs against the application
